...
- **Learn how to use .gitignore and html and css linters**
- **Understanding git github, how git flow and works pulling requests**
- **Creating file in git, typing code and commiting in a professinal and understandable way**
...
Clone this repository to your desired folder:ssh key: git@github.com:Munyabelden/HelloSe
tup.git
...
- [ ] **Javascript to make more animated and responsive**
- [ ] **Images and videos to make it more inviting**
